...
// Search implements binary search
...
// CheckerFunc verifies the solution
func CheckerFunc(fn func([]int, int) int, nums []int, target, expected int) {
...
func main() {
    ...
    CheckerFunc(Search, nums, target, expected)
} 